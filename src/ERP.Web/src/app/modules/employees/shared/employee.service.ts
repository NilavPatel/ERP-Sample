...
export class EmployeeService {
    ...
    getEmployeePersonalDetailById(data: any): Observable<any> {
        return this.http.post<any>(environment.apiURL + '/EmployeePersonalDetail/GetEmployeePersonalDetailById', data);
    }

    updateEmployeePersonalDetail(data: any): Observable<any> {
        return this.http.post<any>(environment.apiURL + '/EmployeePersonalDetail/UpdateEmployeePersonalDetail', data);
    }
